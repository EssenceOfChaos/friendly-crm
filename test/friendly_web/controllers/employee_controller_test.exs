defmodule FriendlyWeb.EmployeeControllerTest do
  use FriendlyWeb.ConnCase

  alias Friendly.Team

  @create_attrs %{admin: true, email: "some email", first_name: "some first_name", last_name: "some last_name", telephone: "some telephone"}
  ...
  def fixture(:employee) do
    {:ok, employee} = Team.create_employee(@create_attrs)
    employee
  end
