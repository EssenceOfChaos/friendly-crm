defmodule FriendlyWeb.TaskControllerTest do
  use FriendlyWeb.ConnCase

  alias Friendly.Team

  @create_attrs %{description: "some description", due: ~N[2010-04-17 14:00:00.000000]}
  @update_attrs %{description: "some updated description", due: ~N[2011-05-18 15:01:01.000000]}
  @invalid_attrs %{description: nil, due: nil}

  def fixture(:task) do
    {:ok, task} = Team.create_task(@create_attrs)
    task
  end
